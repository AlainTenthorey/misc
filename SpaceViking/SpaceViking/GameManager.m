...
#pragma mark -
#pragma mark Singleton creation code
...
#pragma mark -
#pragma mark Play/Stop Sound code
...
#pragma mark -
#pragma mark Sound loading code
...
-(NSDictionary *)getSoundEffectsListForSceneWithID:(SceneTypes)sceneID {
    ...
    if ((soundEffectsState == nil) ||
        ...
        for (NSString *SoundEffectKey in listOfSoundEffectFiles) {
            [soundEffectsState setObject:[NSNumber numberWithBool:SFX_NOTLOADED] 
                                  forKey:SoundEffectKey];
        } 
    }
...
-(void)loadAudioForSceneWithID:(NSNumber*)sceneIDNumber {
    ...
    for( NSString *keyString in soundEffectsToLoad )
    {
        ...
        [soundEffectsState setObject: [NSNumber numberWithBool:SFX_LOADED] 
                              forKey:keyString];
    }
    [pool release];
}
